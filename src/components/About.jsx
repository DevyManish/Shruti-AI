                        ...
                        <div className="p-4 lg:w-1/2">
                            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                                ...
                                <div className="flex-grow sm:pl-8">
                                    ...
                                    <span className="inline-flex">
                                        <Link className="text-gray-500" href='https://www.linkedin.com/in/pratyushsingha/'>
                                            <svg
                                                fill="none"
                                                stroke="currentColor"
                                                strokeLinecap="round"
                                        ...
                                        <Link className="ml-2 text-gray-500" href='https://twitter.com/_being_pratyush'>
                                            <svg
                                                fill="none"
                                                stroke="currentColor"
                                                strokeLinecap="round"
                                        ...
                                        <Link className="ml-2 text-gray-500" href='https://www.instagram.com/_i_am_pratyush04/'>
                                            <svg
                                                fill="none"
                                                stroke="currentColor"
                                                strokeLinecap="round"
