                        ...
                        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                            ...
                            <div className="flex-grow sm:pl-8">
                                ...
                                <span className="inline-flex">
                                    <a className="text-gray-500" href='https://www.linkedin.com/in/manish-gupta-9a6658266/'>
                                        <svg
                                            fill="none"
                                            stroke="currentColor"
                                            strokeLinecap="round"
                                    ...
                                    <a className="ml-2 text-gray-500" href='https://twitter.com/l_m_manish'>
                                        <svg
                                            fill="none"
                                            stroke="currentColor"
                                            strokeLinecap="round"
                                    ...
                                    <a className="ml-2 text-gray-500" href='https://www.instagram.com/l_m_manish/'>
                                        <svg
                                            fill="none"
                                            stroke="currentColor"
                                            strokeLinecap="round"
                        ...
                        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                            ...
                            <div className="flex-grow sm:pl-8">
                                ...
                                <span className="inline-flex">
                                    ...
                                    <a className="ml-2 text-gray-500" href='https://www.instagram.com/_i_am_pratyush04/'>
                                        <svg
                                            fill="none"
                                            stroke="currentColor"
                                            strokeLinecap="round"
